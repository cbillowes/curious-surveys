...
export const NEXT_PUBLIC_FIREBASE_FUNCTIONS_DOMAIN =
  process.env.NEXT_PUBLIC_FIREBASE_FUNCTIONS_DOMAIN;

  console.log(process.env.NEXT_PUBLIC_FIREBASE_FUNCTIONS_DOMAIN);